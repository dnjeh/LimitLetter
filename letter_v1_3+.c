    ...
    if(lselect) {                                                  //읽기시 출력 코드들                                    
        ...
        for(k=0;k<(int)letter_mainc[0]/4+(((int)letter_mainc[0]%4)/((int)letter_mainc[0]%4));k++) { 
            for(i=0;i<4&&((k*4+i)<(int)letter_mainc[0]);i++) {                              //페이지, 문단별 출력
                CursorView(0);
                gotoxy(44, 45);
                printf(" %02d / %02d", i+1, letter_mainc[0]);
                for(j=0;j<8;j++) {
                    gotoxy(44, 5+i*9+j);
...
void drawletter() {   //편지 모양 쓰기
    ...
    for(_i=0;_i<20;_i++) {
        ...
        switch(_i) {
            ...
            case 10: printf("|                          __________                          |"); break;        
            case 11: printf("|        ___  _                                                |"); break;
            case 12: printf("|       / (_)| |          o                                    |"); break;
            case 13: printf("|      |     | |     ,_       , _|_  _  _  _    __,   ,        |"); break;
            case 14: printf("|      |     |/ \\   /  |  |  / \\_|  / |/ |/ |  /  |  / \\_      |"); break;
            case 15: printf("|       \\___/|   |_/   |_/|_/ \\/ |_/  |  |  |_/\\_/|_/ \\/       |"); break;
