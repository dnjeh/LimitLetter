...
int l_lim[3][4] = {0, };
int l_mc=0, lselect=2;
char  *command=NULL;
FILE *fp=NULL, *fp2=NULL;
char l_tri[3][102]={'\0', }, l_tit[102]={'\0', }; 
char l_ind[101][40]={'\0',}, path[8] = "*.let";
time_t t = 0;
struct tm* monthandday = NULL;
...
void draw_letter() {   //편지 모양 쓰기
    ...
    for(_i=0;_i<20;_i++) {
        ...
        switch(_i) {
            ...
            case 13: printf("|           ,          _  _  _    _  _  _    _   ,_            |"); break;
            case 14: printf("|          /__/|   |  / |/ |/ |  / |/ |/ |  |/  /  |           |"); break;
            case 15: printf("|           _/  \\_/|_/  |  |  |_/  |  |  |_/|__/   |_/         |"); break;
            case 16: printf("|                          pre_shotv1                          |"); break;            
