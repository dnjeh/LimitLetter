...
int time_vaild();
int letter_etimelimit[4] ={2022, 9, 2, 2}, letter_stimelimit[4] ={2022, 9, 1, 20}, letter_ntime[4]; //ï¿½ï¿½È¿ï¿½â°£(ï¿½ï¿½, ï¿½ï¿½, ï¿½ï¿½, ï¿½ï¿½) ï¿½Ô·ï¿½
...
int main(){
    ...
    char  *letter_top    = {"ÇÑ ¶§ Ãµ¾ÇÀÌ¶ó°í ºÒ¸®¾ú´ø ºÐ²²"};
    char  *letter_bottom = {"2022³â 9¿ù 1ÀÏ, ÇÑ ¶§ ÃÊ¶÷ÀÌ¶ó°í ºÒ·È´ø ÀÚ°¡"};
    char  *letter_ps     = {"Ãß½Å : »ýÀÏ ÃàÇÏµå·Á¿ä, ÀÌ¹øÀÌ Ã³À½ÀÏ·Á³ª?"};
    time_t t;
    t = time(NULL);
