...
int time_vaild();
int letter_etimelimit[4] ={2022, 9, 4, 23}, letter_stimelimit[4] ={2022, 9, 4, 1}, letter_ntime[4]; //ï¿½ï¿½È¿ï¿½â°£(ï¿½ï¿½, ï¿½ï¿½, ï¿½ï¿½, ï¿½ï¿½) ï¿½Ô·ï¿½
...
int main(){
    ...
    " ¾îÁ¦ ´ç½ÅÀÇ »ýÀÏÀÌ¶ó´Â ¼Ò¹®À» µé¾úÀ¸³ª,",
    "°³ÀÎÀûÀÎ »çÁ¤À¸·Î ÀÌ·± ÇüÅÂ·Î ¼±¹°À» º¸³»°íÀÚ ÇÏ´Ï",
    "ÀÌ·Î ÀÎÇØ ¼±¹°ÄÚµå¸¦ º¸³»°íÀÚ ÇÔ",
    "SQ2APYVSY9",
    "*ÁÖÀÇ* ÇØ´ç ¸Þ¼¼Áö´Â ¿À´Ã ÇÏ·ç µ¿¾È¸¸ À¯È¿ÇÔ",
    "",
    "",
    ""
    },{                              //2ï¿½ï¿½ï¿½ï¿½
    ...
    char  *letter_bottom = {"2022³â 9¿ù 4ÀÏ, ÇÑ ¶§ ÃÊ¶÷ÀÌ¶ó°í ºÒ·È´ø ÀÚ°¡"};
